...
var (
	currencyAllColumns            = []string{"id", "base", "base_external_id", "quote", "quote_external_id", "price", "updated_at"}
	currencyColumnsWithoutDefault = []string{"base", "base_external_id", "quote", "quote_external_id", "price", "updated_at"}
