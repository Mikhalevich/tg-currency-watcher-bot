...
type User struct {
	...
	NextNotificationTime      null.Time `boil:"next_notification_time" json:"next_notification_time,omitempty" toml:"next_notification_time" yaml:"next_notification_time,omitempty"`
...
var UserTableColumns = struct {
	...
	NextNotificationTime:      "users.next_notification_time",
}
...
var UserWhere = struct {
	...
	NextNotificationTime      whereHelpernull_Time
}{
	...
	NextNotificationTime:      whereHelpernull_Time{field: "\"users\".\"next_notification_time\""},
}
...
var (
	userAllColumns            = []string{"id", "chat_id", "created_at", "notification_interval_hours", "last_notification_time", "next_notification_time"}
	userColumnsWithoutDefault = []string{"chat_id", "created_at", "notification_interval_hours", "last_notification_time"}
	userColumnsWithDefault    = []string{"id", "next_notification_time"}
	userPrimaryKeyColumns     = []string{"id"}
	userGeneratedColumns      = []string{"id", "next_notification_time"}
)
